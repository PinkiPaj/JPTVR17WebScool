        ...
        String path = request.getServletPath();
            switch (path){
                ...
                case "/listReaders":
                    ...
                    break;
                case "/editingSubject":
                    request.getRequestDispatcher("/editingSubject.jsp").forward(request, response);
                    break;
                case "/editingGrade":
                    request.getRequestDispatcher("/editingGrade.jsp").forward(request, response);
                    break;
                case "/editingPerson":
                    request.getRequestDispatcher("/editingPerson.jsp").forward(request, response);
                    break;
            }
        }
